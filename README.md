...
canvas{
    background-color:rgb( 122,227,225);
    box-shadow: inset 0 0 5px #be7025;
...
.newshape{
    ...
    border: 2px solid rgb(225,163,255);
    border-radius: 25px;
    color: rgb(74,21,3);
    padding: 15px 32px;
    text-align: center;
...
<body>
    ...
    <div class="container">
        ...
        <center>
            ...
            <button onclick="change_color(this)" id="cypher" style="background: rgb(32, 59, 59);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(55, 51, 113);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(86, 36, 56);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(82, 10, 5);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(5, 80, 39);"></button>
            <button onclick="change_color(this)" id="cypher" style="background: rgb(0, 0, 0);"></button>
        </center>
    </div>
    <br/>
    <center>
    <div class="footer">Developed by K DeviJhansi</div>
    </center>
    <script type="text/javascript">
